  ...
  return (
    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center mx-auto text-start">
        ...
        >
          私の得意分野はデザインとワードプレスの融合にあります。豊富な経験と幅広い知識を持ちながらも、常に最新のトレンドや技術に対して敏感であり、クライアントのニーズに合わせた魅力的なウェブサイトを制作します。信頼性の高いパートナーとして、ビジネスのオンラインプレゼンスを成功させるお手伝いをします。Webデザイナーとして3年、現在はデザイナー兼コーダーとして活動しています。お客様のアイデアに込めた心を聞いてこれを現実にすることが私がすることだと考えており、何よりもお客様の悩みを解決することが最善という原則に固守しています。LP制作のツールは「Figma」、「XD」、「Photoshop」、「Illustrator」と「VS Code」や「Dreamweaver」が利用可能です。
        </motion.p>
